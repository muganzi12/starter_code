...
# Do not remove this line, it imports local settings if they exist, allowing for environment-specific overrides.
try:
    from .env.local import *  # noqa: F403
except ImportError:
    print("\n\nNo local settings found, using default settings.\n\n")